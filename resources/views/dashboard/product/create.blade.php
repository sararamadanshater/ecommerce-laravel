                            ...
                            <div class="card-box">
                                ...
                                <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data" data-parsley-validate novalidate>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="agent" type="text" name="agent" required placeholder="@lang('dashboard.agent')" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="cost" type="text" name="cost" required placeholder="@lang('dashboard.cost')" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
