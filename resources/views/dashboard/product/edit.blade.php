                        ...
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <form method="POST" action="{{ route('products.update', $product['id']) }}" enctype="multipart/form-data" data-parsley-validate novalidate>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="agent">@lang('dashboard.agent')</label>
                                        <input id="agent" type="text" name="agent" required placeholder="@lang('dashboard.agent')" class="form-control" value="{{ $product['agent'] }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    {{-- <div class="form-group col-md-6">
                                        ...
                                        <input id="code" type="text" name="code" required placeholder="@lang('dashboard.code')" class="form-control" value="{{ $product['code'] }}">
                                    </div> --}}
                                    <div class="form-group col-md-6">
                                        <label for="expire">@lang('dashboard.expire')</label>
                                        <input id="expire" type="date" name="expire" required placeholder="@lang('dashboard.expire')" class="form-control" value="{{ $product['expire'] }}">
                                    </div>
                                    <div class="form-group col-md-6">
